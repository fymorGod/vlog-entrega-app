...
export const ProdutoScan = () => {
    ...
    const [qtdTentativa, setQtdTentativa] = useState<number>(null);
    ...
    const getDataAuditoriaItem = async () => {
        try {
            ...
            setQtdTentativa(response.data.qtdTentativa)
                        ...
                        >
                            <View style={{ 
                                ...
                                <View style={{ 
                                    ...
                                    onPress={() => 
                                        qtdTentativa < 3 ? 
                                    updateReconferir(selectedItem.id, parseInt(manualProduto), selectedItem.codBarrasIu)
